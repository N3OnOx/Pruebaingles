...
public class Main {
    public static void main(String[] args) {
        ...
        rellenarObjeto(linea, paqViajes);
                            ...
                            do {
                                ...
                                switch (opcion) {
                                    case 1:
                                        ...
                                        break;
                                    case 2:
                                        estudiar(paqViajes, palabrasErroneas);
                                        break;
                                    case 3:
                                        traductor(paqViajes);
                                        break;
    ...
    private static void nuevaPalabra(ArrayList<Palabra> paqViajes, ArrayList<String> diccionarioIngles, ArrayList<String> diccionarioEspannol){
        ...
        if (ing.endsWith("*")){
            ...
            especial = ing.replace("(","");
            especial = especial.replace(")","");
            String parts[] = especial.split(" ");

            for (int i = 0; i < parts.length; i++){
                for (int j = 0; j < diccionarioEspannol.size(); j++){
                    if (parts[i].equalsIgnoreCase(diccionarioEspannol.get(j))){
                        checkIng = true;
                        break;
                    }else{
                        checkIng = false;
        ...
        if (checkIng) {
            ...
            if (check) {
                ...
                if (ing.endsWith("*")){
                    ...
                    for (int i = 0; i < parts.length; i++){
                        System.out.print("");
                        for (int j = 0; j < diccionarioIngles.size(); j++){
                            if (parts[i].equalsIgnoreCase(diccionarioIngles.get(j))){
                                checkIng = true;
                                break;
                            }else{
                                checkIng = false;
    ...
    private static void estudiar(ArrayList<Palabra> paqViajes, ArrayList<Palabra> palabrasErroneas){
        ...
        do {
            ...
            while (random==estudiarPalabras.size()) {
                ...
                if (ing.equalsIgnoreCase("salir")) {
                    ...
                    System.out.println("!!!!!!!!!!!!!!!!!!!Incorrecto --> "+estudiarPalabras.get(random).getIng());
    ...
    private static void estudiar(ArrayList<PhrasalVerbs> phrasalVerbs){
    ...
    private static void traductorPhrasal(ArrayList<PhrasalVerbs> phrasalVerbs){
        ...
        for (PhrasalVerbs phrasalVerbs1 : phrasalVerbs) {
            if (phrasalVerbs1.getEspannol().equalsIgnoreCase(line)){
                ...
                System.out.println("No existe ese phrasal verb");
                break;
            }
        }
    }
    ...
    private static void cargarArchivo(ArrayList<String> linea){
    ...
    private static void rellenarObjeto(ArrayList<String> linea, ArrayList<Palabra> paqViajes){
